...
class DashboardWorld extends React.Component {
  ...
  render(){
    ...
    let countryCases = countryCollection.getCountryCases()
    // let countryCasesPerMillion = countryCollection.getCountryCasesPerMillion()
    let contryCasesInLastDay = countryCollection.getCountryCasesStartingNDaysAgoDuringMDays(2+nbDayFixer, 3)
    let countryDeaths = countryCollection.getCountryDeaths()
    let contryDeathsInLastDay = countryCollection.getCountryDeathsStartingNDaysAgoDuringMDays(2+nbDayFixer, 3)
        ...
        <div className="info-grid">
          ...
          <div className="cell">
            <div className="cell-inner" style={{float: 'left'}}>
              ...
              <p className="cell-section">
                <span className="cell-subtitle">(total per country)</span><br/>
                <Pie data={countryDeathsPieChartData} options={pieOptions}/>
              </p>

              <p className="cell-section">
                <span className="cell-subtitle">(last 3 days per country)</span><br/>
                <Pie data={countryDeathsLastThreeDaysPieChartData} options={pieOptions}/>
              </p>
